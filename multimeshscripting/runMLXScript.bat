...
rem Example Syntax: 
rem "C:\Program Files\VCG\MeshLab\meshlabserver.exe" -s input\boulder-mini1.ply -o output\boulder-mini1.ply -om vc fq wn
...
rem Example Syntax: 
rem "C:\Program Files\VCG\MeshLab\meshlabserver.exe" -s input\boulder-mini1.ply -o output\boulder-mini1.ply -s scripts\simple_script.mlx -om vc fq wn
